...
export const FEATURE_CARDS_MOCK: ReadonlyArray<FeatureCard> = [
  ...
  },
  {
    ...
    description: 'Recibe rutas por etapas con objetivos, proyectos sugeridos y tiempo estimado para cada nivel.',
    icon: '✹',
    tone: 'neutral'
  },
  {
    title: 'Perfil Profesional',
    description: 'Construye tu perfil con fortalezas, brechas de habilidades y recomendaciones accionables.',
    icon: '⋒',
    tone: 'neutral'
  },
  {
    title: 'Mentor IA 24/7',
    description: 'Haz preguntas en cualquier momento y obtén recomendaciones personalizadas para tu meta profesional.',
    icon: '◍',
    tone: 'neutral'
  }
];
...
export const PROGRESS_CARD_MOCK: ProgressCard = {
  ...
  description: 'Mide cuanto avanzaste hacia la carrera objetivo segun habilidades clave del mercado.',
