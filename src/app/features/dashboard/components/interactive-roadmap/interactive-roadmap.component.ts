...
@Component({
                  ...
                  @if (!last) {
                    <div
                      ...
                      [class.timeline__connector--active]="
                        isCompleted(node.id) || isCurrent(node.id)
                      "
                    ></div>
                  }
                  <!-- Node card -->
                      ...
                      @if (node.resources && node.resources.length > 0) {
                        <button class="resources-toggle" (click)="toggleResources(node.id)">
                          <i
                            ...
                            [class.bi-chevron-up]="expandedNode() === node.id"
                          ></i>
  ...
  styles: [
    ...
    ═══════════════════════════════════════ */
      ...
      .paths-carousel::-webkit-scrollbar {
        display: none;
      }
    ...
    ═══════════════════════════════════════ */
      ...
      .nodes-header__subtitle {
        font-size: 0.6875rem;
        color: #64748b;
        margin: 0;
      }

      .nodes-header__progress {
        display: flex;
        align-items: center;
      }
      .progress-ring {
    ...
    ═══════════════════════════════════════ */
      ...
      .nodes-summary__item i {
        font-size: 0.8125rem;
      }
      .nodes-summary__item--done {
        color: #10b981;
      }
      .nodes-summary__item--active {
        color: #3b82f6;
      }
      .nodes-summary__item--pending {
        color: #64748b;
      }
