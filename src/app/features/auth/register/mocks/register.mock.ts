...
export const REGISTER_VIEW_MODEL_MOCK: RegisterViewModel = {
  productName: 'Itera',
  visualSubtitle:
    'Acelera tu progreso con mentoria impulsada por IA y decisiones de carrera basadas en datos.',
  visualBullets: [
    {
      title: 'Mentoria IA 24/7',
      description:
        'Acompanamiento continuo para resolver dudas y definir tu siguiente paso profesional.',
      icon: 'bi bi-stars',
    },
    {
      title: 'Rutas Personalizadas',
      description:
        'Planes dinamicos alineados a demanda laboral, tendencias y objetivos salariales.',
      icon: 'bi bi-signpost-split-fill',
    },
    {
      title: 'Analisis de Brechas',
      description:
        'Detecta deficit de habilidades y prioriza aprendizaje sin esfuerzo desperdiciado.',
      icon: 'bi bi-activity',
    },
  ],
  mentorQuote:
